...
function PasswordGeneratorContextProvider(props) {
    ...
    const generateSecurePassword = async() => {
       const response = await fetch(`https://api.api-ninjas.com/v1/passwordgenerator?length=${context.criteria.passwordLength}&exclude_numbers=${context.criteria.numbersRequired}&exclude_special_chars=${context.criteria.specialCharactersRequired}`, {
            method: "GET",
            headers: {
    ...
    console.log("Results: ", securePassword);
    return (
