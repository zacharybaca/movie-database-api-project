        ...
        <form id="criteria-form" name="criteria-form">
          <div id="numbers-container">
            ...
            <input
              ...
              checked={context.criteria.numbersRequired}
            />
          </div>
          <div id="special-container">
            <label htmlFor="specialCharactersRequired">
              Exclude Special Characters{" "}
            </label>
            <input
              type="checkbox"
              id="special"
              name="specialCharactersRequired"
              onChange={context.handleChange}
              checked={context.criteria.specialCharactersRequired}
            />
          </div>
          <div id="amount-container">
            ...
            <input
              ...
              step="1"
              onChange={context.handleChange}
              value={context.criteria.passwordLength}
            />
          </div>
        </form>
        <div id="button-container">
          <button type="button" onClick={passwordContext.generate}>
            Generate Secure Password
          </button>
          <button
            type="button"
            onClick={() =>
              context.copyPassword(passwordContext.generatedPassword)
            }>
            Copy Password
          </button>
          <button type="button" id="qr-button">
            <Link
              to="/generate-qr-code"
              id="qr-link"
